...
router.get("/app/updateroom/:hospitalNumber/:futureRoom", (req, res) => {
  ...
  Promise.all([
    ...
    .then((data) => {
      ...
      // Check if the currentRoom is empty
      if (
        rooms &&
        patient &&
        futureRoomObject &&
        ...
        // Unassign the current room of the patient
        ...
        // Assign him to the current room
        patient.room = futureRoomObject.name;
        patient.save();

        // Set the futureRoom to be busy
    ...
    Promise.all([
      ...
      .then((data) => {
        ...
        if (
          ...
          //Unassign the current room of the patientWithRoom
